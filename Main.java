...
//
//        try{
//            Almoxarifado almoxarifado = new Almoxarifado("Almoxarifado", 1);
//        }catch (QuantidadeLimiteFuncionariosException e){
//            System.out.println(e.getMessage());
//        }
//
//        Funcionario func = new Funcionario("Pedro","Liboni", "123", 23, Genero.MASCULINO);
//
//        Salario salarioFunc1 = new Salario(500, 500, 6000, func);
//
//        salarioFunc1.calcularSalario(func);
//
//        System.out.println(salarioFunc1);
